...
class RsiMacd(BaseStrategy):
    def __init__(self, name: str, params: Dict, tfs: Dict[str, str]):
        ...
        self.atr_multiplier = 1 #self.params["atr_inputs"]["atr_multiplier"]
    ...
    def analyze_market_structure(self, last_kline):
        ...
        # === MACD Condition ===
        print("MACD",round(self.indicators["macdhist"].iloc[-3],5),round(self.indicators["macd"].iloc[-3],5), round(self.indicators["macd"].iloc[-1],5))
